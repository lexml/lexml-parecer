...
type OnSearchFn = ((q: string) => Option[] | string[] | Promise<Option[] | string[]>) | undefined;
...
declare class EditorTextoRicoComponent extends LitElement {
    ...
    setTitle: (toolbarContainer: HTMLElement, seletor: string, title: string) => void;
...
type WaVariant = 'brand' | 'info' | 'success' | 'warning' | 'danger' | 'neutral';
type WaIconWeight = 'regular' | 'solid' | 'light' | 'thin' | 'duotone';
declare function alertarInfo(msg: string, opts?: {
    variant?: WaVariant;
    duration?: number;
    icon?: string;
